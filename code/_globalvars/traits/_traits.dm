...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_UNDOCUMENTED" = TRAIT_UNDOCUMENTED, // DARKPACK EDIT ADD - Undocumented quirk
		"TRAIT_WALLET_HATER" = TRAIT_WALLET_HATER, // DARKPACK EDIT ADD - Spawn with Wallet preference
	),
